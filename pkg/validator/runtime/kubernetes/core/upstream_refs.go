...
var upstreamRefs = map[string]runtime.UpstreamRef{
	// --- container ---------------------------------------------------------
	"kubernetes/container/name-invalid": {
	...
	"kubernetes/container/port-name-invalid": {
		Path:        coreValidationPath,
		...
		Note: "Ports the IsValidPortName branch only, which upstream applies solely when a port name is " +
			...
			"covered by kubernetes/container/duplicate-port-names (Duplicate), kubernetes/container/port-number-range " +
			"(containerPort), kubernetes/container/host-port-range (hostPort) and kubernetes/container/port-protocol-invalid " +
			"(protocol).",
	},

	"kubernetes/core/replicationcontroller-replicas-invalid": {
		Path:        coreValidationPath,
	...
	"kubernetes/core/replicationcontroller-selector-invalid": {
		Path:        coreValidationPath,
	...
	"kubernetes/core/replicationcontroller-min-ready-seconds-invalid": {
		Path:        coreValidationPath,
		Functions:   []string{"ValidateReplicationControllerSpec"},
		Digest:      "sha256:97e83579d67da9c5f839b93d0d438c2fb09d143f7d5d4ee12f54e82d5b93f29d",
		ValidatedAt: validatedAt,
	...
	"kubernetes/container/duplicate-port-names": {
		Path:        coreValidationPath,
		Functions:   []string{"validateContainerPorts"},
		Digest:      "sha256:0c583e14a5bf64699161f2202eeb01c4d80f95a7a3525b2cf60ac1070f15fa51",
		ValidatedAt: validatedAt,
		Note: "Ports the allNames Duplicate branch only. The sibling branches of validateContainerPorts " +
			"are covered by kubernetes/container/port-name-invalid (IsValidPortName), kubernetes/container/port-number-range " +
			"(containerPort), kubernetes/container/host-port-range (hostPort) and kubernetes/container/port-protocol-invalid " +
			"(protocol).",
	},
	"kubernetes/container/port-number-range": {
		Path:        coreValidationPath,
		Functions:   []string{"validateContainerPorts"},
		Digest:      "sha256:0c583e14a5bf64699161f2202eeb01c4d80f95a7a3525b2cf60ac1070f15fa51",
		ValidatedAt: validatedAt,
		Note: "Ports the containerPort range branch, which upstream expresses as " +
			...
			"kubernetes/container/duplicate-port-names, kubernetes/container/port-name-invalid, kubernetes/container/host-port-range and " +
			"kubernetes/container/port-protocol-invalid.",
	},
	"kubernetes/container/host-port-range": {
		Path:        coreValidationPath,
		Functions:   []string{"validateContainerPorts"},
		Digest:      "sha256:0c583e14a5bf64699161f2202eeb01c4d80f95a7a3525b2cf60ac1070f15fa51",
		ValidatedAt: validatedAt,
		Note: "Ports the hostPort range branch, which upstream expresses as " +
			...
			"function are covered by kubernetes/container/duplicate-port-names, kubernetes/container/port-name-invalid, " +
			"kubernetes/container/port-number-range and kubernetes/container/port-protocol-invalid.",
	},
	"kubernetes/container/port-protocol-invalid": {
		Path:        coreValidationPath,
		Functions:   []string{"validateContainerPorts"},
		...
		Note: "Ports the !supportedPortProtocols.Has(port.Protocol) -> field.NotSupported branch " +
			...
			"kubernetes/container/duplicate-port-names, kubernetes/container/port-name-invalid, kubernetes/container/port-number-range " +
			"and kubernetes/container/host-port-range.",
		Additional: []runtime.UpstreamRef{{
			Path:        coreValidationPath,
	...
	"kubernetes/container/mount-propagation-value": {
		Path:        coreValidationPath,
	...
	"kubernetes/container/termination-message-policy-value": {
		Path:        coreValidationPath,
		Functions:   []string{"validateContainerCommon"},
		Digest:      "sha256:8f708a22858be520690bd972483bfcc649bcc37ee757c38dd24113e2bfa19ae0",
		ValidatedAt: validatedAt,
	...
	// --- pod spec ----------------------------------------------------------
	"kubernetes/pod-spec/restart-policy-value": {
		Path:        coreValidationPath,
	...
	"kubernetes/pod-spec/dns-policy-value": {
		Path:        coreValidationPath,
	...
	"kubernetes/pod-spec/toleration-operator-value": {
		Path:        coreValidationPath,
	...
	"kubernetes/pod-spec/affinity-node-selector-invalid": {
		Path:        coreValidationPath,
	...
	"kubernetes/pod-spec/pod-affinity-invalid": {
		Path:        coreValidationPath,
	...
	"kubernetes/pod-spec/topology-spread-invalid": {
		Path:        coreValidationPath,
	...
	"kubernetes/pod-spec/service-account-name-invalid": {
		Path:        coreValidationPath,
		Functions:   []string{"ValidatePodSpec"},
		Digest:      "sha256:29b2c14aa676080fcdd79baf32563b9b20e3c616763a2eb42dd07ab58ad490b6",
		ValidatedAt: validatedAt,
	...
	"kubernetes/pod-spec/active-deadline-seconds-negative": {
		Path:        coreValidationPath,
		Functions:   []string{"ValidatePodSpec"},
		Digest:      "sha256:29b2c14aa676080fcdd79baf32563b9b20e3c616763a2eb42dd07ab58ad490b6",
		ValidatedAt: validatedAt,
	...
	// --- resources ---------------------------------------------------------
	"kubernetes/resources/resource-requests-greater-than-limits": {
		Path:        coreValidationPath,
	...
	"kubernetes/resources/resource-quantity-negative": {
		Path:        coreValidationPath,
	...
	// --- volume ------------------------------------------------------------
	"kubernetes/volume/duplicate-volume-names": {
		Path:        coreValidationPath,
	...
	"kubernetes/volume/secret-name-required": {
		Path:        coreValidationPath,
	...
	"kubernetes/volume/configmap-name-required": {
		Path:        coreValidationPath,
		...
		ValidatedAt: validatedAt,
		Note:        "Ports the len(configMapSource.Name) == 0 -> field.Required branch. As with kubernetes/volume/secret-name-required this is a required-field rule, not a live lookup.",
	},

	// --- object metadata ---------------------------------------------------
	"kubernetes/core/object-meta-name-invalid": {
		Path:        objectMetaPath,
	...
	"kubernetes/core/object-meta-labels-invalid": {
		Path:        labelsPath,
	...
	"kubernetes/core/object-meta-annotations-invalid": {
		Path:        objectMetaPath,
	...
	// --- core objects ------------------------------------------------------
	"kubernetes/core/configmap-data-size-exceeded": {
		Path:        coreValidationPath,
	...
	"kubernetes/core/limitrange-max-min-invalid": {
		Path:        coreValidationPath,
	...
	"kubernetes/core/resourcequota-hard-invalid": {
		Path:        coreValidationPath,
	...
	"kubernetes/core/resourcequota-hard-negative": {
		Path:        coreValidationPath,
