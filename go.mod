...
require (
	github.com/ovn-kubernetes/ovn-kubernetes/go-controller v0.0.0-20260807221535-9a6f16728b15
...
require (
	...
	github.com/openshift/api v0.0.0-20260804210737-0986d0517548 // indirect
