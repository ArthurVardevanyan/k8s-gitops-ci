...
require (
	github.com/ovn-kubernetes/ovn-kubernetes/go-controller v0.0.0-20260803142856-7798ed5d9aaa
...
require (
	...
	github.com/openshift/api v0.0.0-20260731195344-05ea89db4588 // indirect
