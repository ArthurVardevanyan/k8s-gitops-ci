...
The image checks are exemptable independently: `image-checksum` uses
`gitops-ci.k8s.io/exempt-image-checksum`, and `image-fqdn` uses
`gitops-ci.k8s.io/exempt-image-fqdn` (matching a bare shortname such as
`nginx:latest`).
...
| `image-fqdn`       | `pkg/validator/image`                                                                                                                                                      | Yes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
